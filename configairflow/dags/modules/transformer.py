...
class Transformer():
    ...
    def create_dimension_province(self):
        ...
        print('INSERTED TO POSTGRES SUCCESS')
    ...
    def create_dimension_case(self):
        df = self.get_data_from_mysql()
        column_start = ['closecontact_dikarantina','closecontact_discarded','closecontact_meninggal','confirmation_meninggal','confirmation_sembuh', 'probable_diisolasi','probable_discarded','probable_meninggal','suspect_diisolasi','suspect_discarded','suspect_meninggal']
    ...
    def create_province_daily(self):
        ...
        column_start = ['CLOSECONTACT','CONFIRMATION','PROBABLE','SUSPECT','closecontact_dikarantina','closecontact_discarded','closecontact_meninggal','confirmation_meninggal','confirmation_sembuh',
                        'kode_prov','nama_prov','probable_diisolasi','probable_discarded','probable_meninggal','suspect_diisolasi','suspect_discarded','suspect_meninggal','tanggal']
        
        column_end = ['date', 'province_id', 'status', 'total']
        
        data = df[column_start]
        data = data.melt(id_vars= ['tanggal', 'kode_prov'], var_name='status', value_name='total').sort_values(['tanggal', 'kode_prov', 'status']) #could be wrong
    ...
    def create_district_daily(self):
        ...
        column_start = ['CLOSECONTACT','CONFIRMATION','PROBABLE','SUSPECT','closecontact_dikarantina','closecontact_discarded','closecontact_meninggal','confirmation_meninggal','confirmation_sembuh',
                         'kode_kab','nama_kab','probable_diisolasi','probable_discarded','probable_meninggal','suspect_diisolasi','suspect_discarded','suspect_meninggal','tanggal']
